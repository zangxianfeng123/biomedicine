<template>
  <div>
    ...
    <p class="wkb-cmm-text-center wkb-insall-package">
      <el-row>
        <el-col :span="12"><a href="javascript:void(0)">注册新用户</a></el-col>
        <el-col :span="12"><a href="javascript:void(0)">忘记密码？</a></el-col>
      </el-row>
    </p>
